...
void setup(){
  ...
  for (String row : LD) {
    ...
    data[0][i-1] = int(list[0]);
    data[1][i-1] = int(list[1]);   
    data[2][i-1] = int(list[2]); 
    data[3][i-1] = int(list[3]);   
    data[4][i-1] = int(list[4]); 
    data[5][i-1] = int(list[5]);   
    data[6][i-1] = int(list[6]);   
    data[7][i-1] = int(list[7]); 
    i++;
  }
}
